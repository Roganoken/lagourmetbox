 ...
 */
class WIC_Mondialrelay_Model_Mysql4_Carrier_Pointsrelaislds extends Mage_Core_Model_Mysql4_Abstract
{
    ...
    public function uploadAndImport(Varien_Object $object)
    {
        ...
        if (!empty($csvFile)) 
        {
            ...
            $conditionFullName = Mage::getModel('mondialrelay/carrier_pointsrelaislds')->getCode('condition_name_short', $conditionName);
