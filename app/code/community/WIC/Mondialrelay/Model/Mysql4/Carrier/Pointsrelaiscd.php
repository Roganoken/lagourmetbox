 ...
 */
class WIC_Mondialrelay_Model_Mysql4_Carrier_Pointsrelaiscd extends Mage_Core_Model_Mysql4_Abstract
{
	...
	public function getRate(Mage_Shipping_Model_Rate_Request $request)
	{
		...
		Mage::Log('WIC_Mondialrelay_Model_Mysql4_Carrier_Pointsrelaiscd getRate');
    ...
    public function uploadAndImport(Varien_Object $object)
    {
        ...
        if (!empty($csvFile)) 
        {
            ...
            $conditionFullName = Mage::getModel('mondialrelay/carrier_pointsrelaiscd')->getCode('condition_name_short', $conditionName);
