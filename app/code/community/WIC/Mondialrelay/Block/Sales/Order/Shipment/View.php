 ...
 */
class WIC_Mondialrelay_Block_Sales_Order_Shipment_View extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function __construct()
    {
        ...
        if (($_shippingMethod[0] == 'pointsrelais') || ($_shippingMethod[0] == 'pointsrelaiscd') || ($_shippingMethod[0] == 'pointsrelaisld1') || ($_shippingMethod[0] == 'pointsrelaislds'))  {
            $this->_addButton('etiquette', array(
                'label'     => Mage::helper('mondialrelay')->__('Etiquette Mondial Relay'),
                'class'     => 'save',
    ...
    {
        return $this->getUrl('mondialrelay/sales_impression/print', array(
