...
//    }
    ...
    protected function _isCaptureFinal($amountToCapture)
    {
        ...
        Mage::log('#############', null, 'paypal_fraud_error.log');
        
        Mage::log('$amountToCapture', null, 'paypal_fraud_error.log');
        Mage::log($amountToCapture, null, 'paypal_fraud_error.log');
        
        Mage::log('$amountToCapture', null, 'paypal_fraud_error.log');
        Mage::log($orderGrandTotal, null, 'paypal_fraud_error.log');
        
        Mage::log('$this->_formatAmount($this->getBaseAmountPaid(), true)', null, 'paypal_fraud_error.log');
        Mage::log($this->_formatAmount($this->getBaseAmountPaid(), true), null, 'paypal_fraud_error.log');
        
        Mage::log('$this->_formatAmount($this->getBaseAmountPaid(), true) + $amountToCapture', null, 'paypal_fraud_error.log');
        Mage::log($this->_formatAmount($this->getBaseAmountPaid(), true) + $amountToCapture, null, 'paypal_fraud_error.log');
        ...
        if ($orderGrandTotal == $this->_formatAmount($this->getBaseAmountPaid(), true) + $amountToCapture) {
            ...
            Mage::log('TRUE', null, 'paypal_fraud_error.log');
            return true;
        }
            Mage::log('FALSE', null, 'paypal_fraud_error.log');
        return false;
    }
